...
public class S3Manager {
    ...
    private String upload(File uploadFile, String dirName) {
        ...
        String cloudFrontUrl = "https://d1qgcn9we7xs5b.cloudfront.net/" + fileName; // AWS 클라우드 프론트로 접근할 것임
    ...
    public void delete(String reviewImgUrl) { // S3 파일 삭제
        String filePath = reviewImgUrl.replace("https://d1qgcn9we7xs5b.cloudfront.net/", "");
        // Delete 객체 생성
